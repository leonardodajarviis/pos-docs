...
|------------|------|----------|-------|-----------|
| `categoryId` | Số | Có | Nhóm hàng nhỏ nhất | Phải là leaf category, chưa được gán mã giá |
...
|--------|-----------|-------|
| `CATEGORY_NOT_LEAF` | "Chỉ được gắn mã giá cho nhóm hàng nhỏ nhất" | Nhóm hàng không phải leaf category |
...
2. Hệ thống yêu cầu Admin cung cấp thông tin:
   - Nhóm hàng (bắt buộc, phải là leaf category chưa có mã giá)
...
4. Hệ thống kiểm tra tính hợp lệ của dữ liệu:
   - Nhóm hàng là leaf category (không có nhóm con)
...
### 4a. Nhóm hàng không phải leaf category
...
### BR-UC01-001: Quy tắc về loại mã giá
...
### BR-UC01-002: Ràng buộc một mã giá cho một nhóm hàng
...
### BR-UC01-003: Chỉ gắn mã giá cho nhóm hàng lá (Leaf Category)

- Mã giá chỉ có thể được gắn cho **nhóm hàng lá** (leaf category - nhóm không có nhóm con)
...
### BR-UC01-004: Kiểm tra vòng lặp kế thừa (Circular Reference Detection)
...
### BR-UC01-005: Chỉ kế thừa từ mã giá Active
...
### BR-UC01-006: Quy tắc kế thừa và ghi đè hệ số
...
### BR-UC01-007: Trạng thái mặc định khi tạo mới
